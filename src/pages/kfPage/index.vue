...
const connectWebSocket = () => {
  socketFormInline.value.params.token = localStorage.getItem('access_token') 
...
//  }
  let params = {
    ...
    "params": {
      ...
      "user-uuid": userUuid.value,
      "msg": message.value
    }
  }
  messageList.value.unshift({type:'right',content:`${message.value}`})
    ...
    <div class="chat-content" :style="{ height: chatHeight + 'px' }">
      ...
      <div class="chat-footer">
        ...
        <div class="send-btn" :class="{'send-btn-show':sendBtnShow}">
          ...
          <!-- <van-uploader> -->
            <van-button icon="photo-o" type="primary" :max-size="5 * 1024" :max-count="1"  class="sendBtn" v-if="sendBtnShow" @click="closeChat"></van-button>
          <!-- </van-uploader> -->
        </div>
      </div>
    </div>
